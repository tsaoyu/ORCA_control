...
PidObject::PidObject() : error_(3, 0), filtered_error_(3, 0), error_deriv_(3, 0), filtered_error_deriv_(3, 0)
{
    ...
    dynamic_reconfigure::Server<redrov_control::pidConfig> config_server;
    dynamic_reconfigure::Server<redrov_control::pidConfig>::CallbackType f;
...
void PidObject::reconfigureCallback(redrov_control::pidConfig& config, uint32_t level)
{
  if (first_reconfig_)
  {
