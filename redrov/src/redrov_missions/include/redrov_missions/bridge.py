...
class Bridge(object):
    ...
    """
    def __init__(self, device='udp:192.168.2.2:14550', baudrate=115200, **kwargs):
        """
        Args:
    ...
    def set_cmd_wrench(self, pwm_linear_x=1500, pwm_linear_y=1500, pwm_linear_z=1500, pwm_angular_z=1500):
        rc_channel_values = [65535 for _ in range(8)]
